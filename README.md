...
<div align="center">
  ...
  <h3><b>Welcome to To CoinCap Project</b></h3>
...
**Space Travelers** is a simple project developed by React.js and API, Shows famouse crypto coins, prices and it's history.
...
```bash
git clone https://github.com/tawakuliKH/coinCap-React.git
```
